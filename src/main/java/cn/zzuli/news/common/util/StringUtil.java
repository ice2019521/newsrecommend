...
public class StringUtil {
	 ...
	 *                          classType
	 *                          参数类型(String,Integer,Float,Double,BigDecimal) value 值
	...
	/***
	 * 判断编码是否为数字且为2位 符合返回true,不符合返回false
	 * 
	 * @author lichaoyuan
	 * @param code
	 * @return
	 ...
	 * @return
	 */
	public static Integer getStudentNumber(List<Integer> ids) {
